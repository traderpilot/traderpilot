...
from traderpilot_client import __version__
from traderpilot_client.rest_client import TpRestClient
...
def add_arguments(args: Any = None):
    parser = argparse.ArgumentParser(
        prog="traderpilot-client",
        description="Client for the traderpilot REST API",
    )
    parser.add_argument(
...
def main_exec(parsed: dict[str, Any]):
    ...
    client = TpRestClient(server_url, username, password)
