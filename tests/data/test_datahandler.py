...
from traderpilot.data.history.datahandlers.hdf5datahandler import HDF5DataHandler
from traderpilot.data.history.datahandlers.idatahandler import (
    IDataHandler,
    get_datahandler,
...
def test_generic_datahandler_ohlcv_load_and_resave(
    ...
    mocker.patch(
        "traderpilot.data.history.datahandlers.featherdatahandler.read_feather",
        side_effect=Exception("Test"),
    )
    mocker.patch(
        "traderpilot.data.history.datahandlers.parquetdatahandler.read_parquet",
        side_effect=Exception("Test"),
    )
    mocker.patch(
        "traderpilot.data.history.datahandlers.hdf5datahandler.pd.read_hdf",
        side_effect=Exception("Test"),
    )
