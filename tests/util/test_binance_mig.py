...
def test_migration_wrapper(default_conf_usdt, mocker):
    default_conf_usdt["trading_mode"] = "futures"
    binmock = mocker.patch("traderpilot.util.migrations.migrate_binance_futures_data")
    funding_mock = mocker.patch("traderpilot.util.migrations.migrate_funding_fee_timeframe")
