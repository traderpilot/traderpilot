...
def test_backtest_position_adjustment(default_conf, fee, mocker, testdatadir) -> None:
    ...
    mocker.patch(
        "traderpilot.optimize.backtesting.amount_to_contract_precision",
...
def test_backtest_position_adjustment_detailed(default_conf, fee, mocker, leverage) -> None:
    ...
    assert trade.orders[-1].tp_order_tag == "PartIncrease"
    ...
    assert trade.orders[-1].tp_order_tag == "partDecrease"
    assert trade.nr_of_successful_entries == 2
