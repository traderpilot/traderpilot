...
from traderpilot.optimize.optimize_reports.bt_output import text_table_tags
from traderpilot.optimize.optimize_reports.optimize_reports import (
...
def test_store_backtest_results(testdatadir, mocker):
    dump_mock = mocker.patch("traderpilot.optimize.optimize_reports.bt_storage.file_dump_json")
    zip_mock = mocker.patch("traderpilot.optimize.optimize_reports.bt_storage.ZipFile")
