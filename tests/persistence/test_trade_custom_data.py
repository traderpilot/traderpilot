...
def test_trade_custom_data_strategy_compat(mocker, default_conf_usdt, fee):
    ...
    mocker.patch("traderpilot.traderpilotbot.TraderpilotBot.get_real_amount", return_value=None)
    ...
    traderpilot.strategy.custom_exit = custom_exit
    ff_spy = mocker.spy(traderpilot.strategy, "custom_exit")
