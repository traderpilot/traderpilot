...
suitable to run with traderpilot.
"""
...
class TestCCXTExchange:
    ...
    def test_ccxt_fetch_l2_orderbook(self, exchange: EXCHANGE_FIXTURE_TYPE):
        ...
        l2_limit_range = exch._tp_has["l2_limit_range"]
        l2_limit_range_required = exch._tp_has["l2_limit_range_required"]
        if exchangename == "gate":
    ...
    def test_ccxt__async_get_candle_history(self, exchange: EXCHANGE_FIXTURE_TYPE):
        ...
        if not exc._tp_has["ohlcv_has_history"]:
    ...
    def test_ccxt__async_get_candle_history_futures(
        ...
        if candle_type == CandleType.FUNDING_RATE:
            timeframe = exchange._tp_has.get(
                "funding_fee_timeframe", exchange._tp_has["mark_ohlcv_timeframe"]
            )
    ...
    def test_ccxt_fetch_funding_rate_history(self, exchange_futures: EXCHANGE_FIXTURE_TYPE):
        ...
        timeframe_ff = exchange._tp_has.get(
            "funding_fee_timeframe", exchange._tp_has["mark_ohlcv_timeframe"]
        )
