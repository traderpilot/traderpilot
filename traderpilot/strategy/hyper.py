...
from traderpilot.misc import deep_merge_dicts
from traderpilot.optimize.hyperopt_tools import HyperoptTools
from traderpilot.strategy.parameters import BaseParameter
...
class HyperStrategyMixin:
    ...
    def __init__(self, config: Config, *args, **kwargs):
        ...
        """
        self.config = config
        self.tp_buy_params: list[BaseParameter] = []
        self.tp_sell_params: list[BaseParameter] = []
        self.tp_protection_params: list[BaseParameter] = []

        params = self.load_params_from_file()
        params = params.get("params", {})
        self._tp_params_from_file = params
        # Init/loading of parameters is done as part of tp_bot_start().
    ...
    def enumerate_parameters(
        ...
        if category is None:
            ...
            params = getattr(self, f"tp_{category}_params")
    ...
    def tp_load_params_from_file(self) -> None:
        """
        Load Parameters from parameter file
        Should/must run before config values are loaded in strategy_resolver.
        """
        if self._tp_params_from_file:
            # Set parameters from Hyperopt results file
            params = self._tp_params_from_file
    ...
    def tp_load_hyper_params(self, hyperopt: bool = False) -> None:
        """
        ...
        * Parameter defaults
        ...
        buy_params = deep_merge_dicts(
            self._tp_params_from_file.get("buy", {}), getattr(self, "buy_params", {})
        )
        sell_params = deep_merge_dicts(
            self._tp_params_from_file.get("sell", {}), getattr(self, "sell_params", {})
        )
        protection_params = deep_merge_dicts(
            self._tp_params_from_file.get("protection", {}), getattr(self, "protection_params", {})
        )

        self._tp_load_params(buy_params, "buy", hyperopt)
        self._tp_load_params(sell_params, "sell", hyperopt)
        self._tp_load_params(protection_params, "protection", hyperopt)
    ...
    def _tp_load_params(self, params: dict, space: str, hyperopt: bool = False) -> None:
        """
        ...
        param_container: list[BaseParameter] = getattr(self, f"tp_{space}_params")
