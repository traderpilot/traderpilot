...
from traderpilot.strategy.strategy_helper import merge_informative_pair
...
def informative(
    ...
    * {timeframe} - timeframe of informative dataframe.
    ...
    def decorator(fn: PopulateIndicators):
        informative_pairs = getattr(fn, "_tp_informative", [])
        informative_pairs.append(InformativeData(_asset, _timeframe, _fmt, _ffill, _candle_type))
        setattr(fn, "_tp_informative", informative_pairs)  # noqa: B010
        return fn
