class TraderpilotException(Exception):
    """
    Traderpilot base exception. Handled at the outermost level.
    All other exception types are subclasses of this exception type.
    """


class OperationalException(TraderpilotException):
    """
...
class DependencyException(TraderpilotException):
    """
...
class StrategyError(TraderpilotException):
    """
