...
from traderpilot.traderai.base_models.BasePyTorchRegressor import BasePyTorchRegressor
...
from traderpilot.traderai.torch.PyTorchModelTrainer import PyTorchTransformerTrainer
from traderpilot.traderai.torch.PyTorchTransformerModel import PyTorchTransformerModel
...
class PyTorchTransformerRegressor(BasePyTorchRegressor):
    ...
    def predict(
        self, unfiltered_df: pd.DataFrame, dk: TraderaiDataKitchen, **kwargs
        ...
        if self.tp_params.get("DI_threshold", 0) > 0:
