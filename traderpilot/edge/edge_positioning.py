...
from traderpilot.constants import DATETIME_PRINT_FORMAT, UNLIMITED_STAKE_AMOUNT, Config
from traderpilot.data.history import get_timerange, load_data, refresh_data
...
class Edge:
    ...
    def calculate(self, pairs: list[str]) -> bool:
        ...
        for pair, pair_data in preprocessed.items():
            ...
            df_analyzed = self.strategy.tp_advise_signals(pair_data, {"pair": pair})[headers].copy()
