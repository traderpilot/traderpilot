...
from traderpilot.misc import round_dict
...
class IHyperOpt(ABC):
    """
    Interface for traderpilot hyperopt
    ...
    def roi_space(self) -> list[Dimension]:
        ...
        It's used by Traderpilot by default, if no custom roi_space method is defined.
        """
        ...
        #
        # The scaling is designed so that it maps exactly to the legacy Traderpilot roi_space()
