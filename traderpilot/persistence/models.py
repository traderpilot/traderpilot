...
from traderpilot.persistence.custom_data import _CustomData
from traderpilot.persistence.key_value_store import _KeyValueStoreModel
from traderpilot.persistence.migrations import check_migrate
from traderpilot.persistence.pairlock import PairLock
...
def init_db(db_url: str) -> None:
    ...
    try:
        ...
        raise OperationalException(
            f"Given value for db_url: '{db_url}' " f"is no valid database URL! (See {_SQL_DOCS_URL})"
        )
