...
from traderpilot.configuration.deprecated_settings import process_temporary_deprecated_settings
from traderpilot.configuration.directory_operations import create_datadir, create_userdata_dir
from traderpilot.configuration.environment_vars import enironment_vars_to_dict
from traderpilot.configuration.load_config import load_file, load_from_files
...
from traderpilot.misc import deep_merge_dicts, parse_db_uri_for_logging
...
class Configuration:
    ...
    def load_config(self) -> dict[str, Any]:
        ...
        from traderpilot.commands.arguments import NO_CONF_ALLOWED
        ...
        self._process_traderai_options(config)
    ...
    def _process_traderai_options(self, config: Config) -> None:
        self._args_to_config(
            config, argname="traderaimodel", logstring="Using traderaimodel class name: {}"
        )

        self._args_to_config(
            config, argname="traderaimodel_path", logstring="Using traderaimodel path: {}"
        )
