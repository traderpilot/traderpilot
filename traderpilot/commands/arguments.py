...
from traderpilot.commands.cli_options import AVAILABLE_CLI_OPTIONS
from traderpilot.constants import DEFAULT_CONFIG
...
ARGS_LIST_TRADERAIMODELS = ["traderaimodel_path", "print_one_column"]
...
ARGS_LOOKAHEAD_ANALYSIS = [
    a for a in ARGS_BACKTEST if a not in ("position_stacking", "backtest_cache", "backtest_breakdown")
...
class Arguments:
    ...
    def _build_subcommands(self) -> None:
        ...
        self.parser = ArgumentParser(
            prog="traderpilot", description="Free, open source crypto trading bot"
        )
        ...
        # Add list-traderAI Models subcommand
        list_traderaimodels_cmd = subparsers.add_parser(
            "list-traderaimodels",
            help="Print available traderAI models.",
            parents=[_common_parser],
        )
        list_traderaimodels_cmd.set_defaults(func=start_list_traderAI_models)
        self._build_args(optionlist=ARGS_LIST_TRADERAIMODELS, parser=list_traderaimodels_cmd)
