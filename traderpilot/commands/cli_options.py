...
from traderpilot import __version__, constants
from traderpilot.constants import HYPEROPT_LOSS_BUILTIN
...
AVAILABLE_CLI_OPTIONS = {
    ...
    "ui_version": Arg(
        "--ui-version",
        help=(
            "Specify a specific version of TraderUI to install. "
    ...
    "traderaimodel": Arg(
        "--traderaimodel",
        help="Specify a custom traderaimodels.",
        metavar="NAME",
    ),
    "traderaimodel_path": Arg(
        "--traderaimodel-path",
        help="Specify additional lookup path for traderaimodels.",
        metavar="PATH",
    ),
