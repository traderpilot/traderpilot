...
def start_list_exchanges(args: dict[str, Any]) -> None:
    ...
    if args["print_one_column"]:
        ...
        if args["list_exchanges_all"]:
            ...
            title = f"Exchanges available for Traderpilot ({len(available_exchanges)} exchanges):"
...
def start_list_traderAI_models(args: dict[str, Any]) -> None:
    """
    Print files with TraderAI models custom classes available in the directory
    """
    from traderpilot.configuration import setup_utils_configuration
    ...
    model_objs = TraderaiModelResolver.search_all_objects(config, not args["print_one_column"])
    # Sort alphabetically
...
def start_list_markets(args: dict[str, Any], pairs_only: bool = False) -> None:
    ...
    """
    from traderpilot.configuration import setup_utils_configuration
    from traderpilot.exchange import market_is_active
...
def start_show_trades(args: dict[str, Any]) -> None:
    ...
    from traderpilot.configuration import setup_utils_configuration
    from traderpilot.misc import parse_db_uri_for_logging
    from traderpilot.persistence import Trade, init_db
