...
def setup_optimize_configuration(args: dict[str, Any], method: RunMode) -> dict[str, Any]:
    ...
    from traderpilot.util import fmt_coin, get_dry_run_wallet
...
def start_backtesting(args: dict[str, Any]) -> None:
    ...
    logger.info("Starting traderpilot in Backtesting mode")
...
def start_backtesting_show(args: dict[str, Any]) -> None:
    ...
    from traderpilot.optimize.optimize_reports import show_backtest_results, show_sorted_pairlist
...
def start_hyperopt(args: dict[str, Any]) -> None:
    ...
    logger.info("Starting traderpilot in Hyperopt mode")
    ...
    try:
        ...
        logger.info("Another running instance of traderpilot Hyperopt detected.")
        logger.info(
        ...
        # TODO: return False here in order to help traderpilot to exit
...
def start_edge(args: dict[str, Any]) -> None:
    ...
    logger.info("Starting traderpilot in Edge mode")
