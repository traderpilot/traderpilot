...
import traderpilot.exchange as exchanges
from traderpilot.constants import Config, ExchangeConfig
from traderpilot.exchange import MAP_EXCHANGE_CHILDCLASS, Exchange
...
class ExchangeResolver(IResolver):
    ...
    def _load_exchange(exchange_name: str, kwargs: dict) -> Exchange:
        ...
        Only checks for exchanges exported in traderpilot.exchanges
                ...
                result.append(
                    {
                        ...
                        "location_rel: ": exchange.__module__.replace("traderpilot.", ""),
                    }
                )
        return result
