...
from traderpilot.loggers.buffering_handler import FTBufferingHandler
from traderpilot.loggers.rich_handler import FtRichHandler
from traderpilot.loggers.set_log_levels import set_loggers


# from traderpilot.loggers.std_err_stream_handler import FTStdErrStreamHandler
        ...
        if s[0] == "syslog":
            ...
            try:
                ...
                raise OperationalException(
                    ...
                    "directories. If you're running traderpilot using docker, you see this error "
