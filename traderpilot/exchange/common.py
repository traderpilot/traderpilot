...
from traderpilot.constants import ExchangeConfig
from traderpilot.exceptions import DDosProtection, RetryableOrderError, TemporaryError
            ...
            if count > 0:
                ...
                if isinstance(ex, DDosProtection):
                    if kucoin and "429000" in str(ex):
                        ...
                        # see https://github.com/traderpilot/traderpilot/issues/5700 for details.
