...
from traderpilot.enums import CandleType, MarginMode, PriceType, TradingMode
from traderpilot.exceptions import DDosProtection, OperationalException, TemporaryError
from traderpilot.exchange import Exchange
from traderpilot.exchange.binance_public_data import concat_safe, download_archive_ohlcv
from traderpilot.exchange.common import retrier
from traderpilot.exchange.exchange_types import FtHas, Tickers
from traderpilot.exchange.exchange_utils_timeframe import timeframe_to_msecs
from traderpilot.misc import deep_merge_dicts, json_load
from traderpilot.util.datetime_helpers import dt_from_ts, dt_ts
...
class Binance(Exchange):
        ...
        try:
            if self.trading_mode == TradingMode.FUTURES and not self._config["dry_run"]:
                ...
                if position_side.get("dualSidePosition") is True:
                    msg += (
                        "\nHedge Mode is not supported by traderpilot. "
                ...
                if (
                    ...
                    msg += (
                        "\nMulti-Asset Mode is not supported by traderpilot. "
    ...
    def funding_fee_cutoff(self, open_date: datetime):
        ...
        https://github.com/traderpilot/traderpilot/pull/5779#discussion_r740175931
