...
from traderpilot.configuration import running_in_docker
...
from traderpilot.rpc.api_server.ws.message_stream import MessageStream
from traderpilot.rpc.rpc import RPC, RPCException, RPCHandler
...
class ApiServer(RPCHandler):
    ...
    def configure_app(self, app: FastAPI, config):
        from traderpilot.rpc.api_server.api_auth import http_basic_or_jwt_token, router_login
        from traderpilot.rpc.api_server.api_background_tasks import router as api_bg_tasks
        from traderpilot.rpc.api_server.api_backtest import router as api_backtest
        from traderpilot.rpc.api_server.api_download_data import router as api_download_data
        from traderpilot.rpc.api_server.api_pairlists import router as api_pairlists
        from traderpilot.rpc.api_server.api_v1 import router as api_v1
        from traderpilot.rpc.api_server.api_v1 import router_public as api_v1_public
        from traderpilot.rpc.api_server.api_ws import router as ws_router
        from traderpilot.rpc.api_server.deps import is_webserver_mode
        from traderpilot.rpc.api_server.web_ui import router_ui
