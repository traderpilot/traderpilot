...
class OrderSchema(BaseModel):
    ...
    tp_fee_base: float | None = None
    tp_order_tag: str | None = None
...
class TraderAIModelListResponse(BaseModel):
    traderaimodels: list[str]
...
class BacktestTraderAIInputs(BaseModel):
    identifier: str
...
class BacktestRequest(BaseModel):
    ...
    traderaimodel: str | None = None
    traderai: BacktestTraderAIInputs | None = None
