...
from traderpilot.rpc.api_server.api_pairlists import handleExchangePayload
from traderpilot.rpc.api_server.api_schemas import BgJobStarted, DownloadDataPayload
from traderpilot.rpc.api_server.deps import get_config, get_exchange
from traderpilot.rpc.api_server.webserver_bgwork import ApiBG
from traderpilot.util.progress_tracker import get_progress_tracker
...
def __run_download(job_id: str, config_loc: Config):
    try:
        ...
        from traderpilot.data.history.history_utils import download_data

        with FtNoDBContext():
            exchange = get_exchange(config_loc)

            def tp_callback(task) -> None:
            ...
            pt = get_progress_tracker(tp_callback=tp_callback)
