...
from traderpilot.configuration.load_config import CONFIG_PARSE_MODE
from traderpilot.exceptions import OperationalException
from traderpilot.exchange.exchange_types import Tickers
from traderpilot.plugins.pairlist.IPairList import IPairList, PairlistParameter, SupportsBacktesting
...
class RemotePairList(IPairList):
    ...
    def fetch_pairlist(self) -> tuple[list[str], float]:
        headers = {"User-Agent": "Traderpilot/" + __version__ + " Remotepairlist"}
